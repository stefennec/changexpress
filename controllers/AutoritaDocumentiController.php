...
use app\models\AutoritaDocumentiSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AutoritaDocumentiController implements the CRUD actions for AutoritaDocumenti model.
 */
class AutoritaDocumentiController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new AutoritaDocumentiSearch();
