...
/**
 * Autorita_DocumentiSearch represents the model behind the search form of `app\models\AutoritaDocumenti`.
 */
class Autorita_DocumentiSearch extends AutoritaDocumenti
{
    /**
     * {@inheritdoc}
     */
